...
#       ])
  ...
  Flight.create!(departure_airport_id: 5, arrival_airport_id: 1, departure_date: 4.days.from_now, duration: 6)
  Flight.create!(departure_airport_id: 6, arrival_airport_id: 1, departure_date: 5.days.from_now, duration: 4)
  Flight.create!(departure_airport_id: 7, arrival_airport_id: 1, departure_date: 3.days.from_now, duration: 4)
  Flight.create!(departure_airport_id: 8, arrival_airport_id: 1, departure_date: 4.days.from_now, duration: 6)
  Flight.create!(departure_airport_id: 9, arrival_airport_id: 1, departure_date: 5.days.from_now, duration: 4)
